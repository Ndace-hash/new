...
<div className='sub-category-filter'>
  <button className='button sub-button'>Hand-Bag</button>
    <button className='button sub-button'>Back-Pack</button>
  <button className='button sub-button'>Purse/Wallet</button>
  <button className='button sub-button'>Cross-Bag</button>
  <button className='button sub-button'>Hand-BAG</button>
  <button className='button sub-button'>Travelling-BAG</button>
   ...
   <hr />
     ...
     <br />
     <input type="radio" name='brand' className='filter-check' onClick={()=>filter('clothes','brand','bHp')}/>HP
     <br />
     <input type="radio" name='brand' className='filter-check' onClick={()=>filter('clothes','brand','bAdidas')}/>Adidas
     <br />
     <input type="radio" name='brand' className='filter-check' onClick={()=>filter('clothes','brand','bPolo')}/>Polo
     <br />

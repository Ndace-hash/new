...
<div className='sub-category-filter'>
  <button className='button sub-button'>Analog- watches</button>
    <button className='button sub-button'>Digital-watches</button>
    <button className='button sub-button'>Mechanical-watches</button>
  <button className='button sub-button'>Dress-watches</button>
   ...
   <div className=' product-side-bar '>
    ...
    <hr />
     ...
     <div>
            <h3>brand</h3>
     <input type="radio" name='brand' className='filter-check' onClick={()=>filter('clothes','brand','bRolex')}/>Rolex
     <br />
     <input type="radio" name='brand' className='filter-check' onClick={()=>filter('clothes','brand','bHublot')}/>Hublot
     <br />
     <input type="radio" name='brand' className='filter-check' onClick={()=>filter('clothes','brand','bPatek')}/>Patek
     <br />
     <input type="radio" name='brand' className='filter-check' onClick={()=>filter('clothes','brand','bCasio')}/>Casio
     <br />
     <input type="radio" name='brand' className='filter-check' onClick={()=>filter('clothes','brand','bCartiers')}/>Catiers
     <br />
